...
const nyoutube = ('© Zall Bot\nYoutube/Sc :\nhttps://youtube.com/c/RisalTmy')  //ubah di config biar ngk emror
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/ZALL-MAKER-10-01' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin sewa hubungi owner terlebih dahulu*\n\n*Atau klik link dibawah ini*\n_https://wa.me/62895330006855_\n\n*Atau Transfer via*\n- *Gopay Dana Ovo Qris ShopeePay*\n Ke nomer berikut : 0895330006855\n\n_Terima kasih bagi yang sudah donasi_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('https://wa.me/62895330006855')
            }
            break		 
            case 'chat': {
...
⭔ Url : ${anu.url}`,
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 62895330006855`
...
╰──❍`
            ...
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '❗Rules' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🧋 Sewa' }, type: 1 }]
